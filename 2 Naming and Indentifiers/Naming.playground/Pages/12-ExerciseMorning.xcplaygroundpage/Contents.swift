...
let totalTimeOfAllActivities = brushTeeth + uploadPhotos + chooseClothes + shower + goJogging + finishHomework + fixLunch
...
let haveToDo = brushTeeth + shower + finishHomework + fixLunch
let likeToDo = uploadPhotos + chooseClothes + goJogging
