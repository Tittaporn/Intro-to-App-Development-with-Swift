...
let name = "Lee"
let number = 1000
let adjustive = "wonderful"
let noun = "iMac"
let place = "store"
let postive = "happy"
let nagative = "terrible"
let myStory = "Today was a big day for " + name + " They had finally saved up" + number + " dollars and were going to buy a " + adjustive + noun + " They went to the " + noun + place + "  feeling very " + positive + ". But then they felt " + nagative + ". They were all out of " + noun + "!"
