 ...
 */
var chocolateFactoryVotesCount: Int = 0
var beachVotesCount: Int = 0

for tripDestinationVote in tripDestinationVotes {
    let beachVotes = ClassTripDestination.beach
    if tripDestinationVote == beachVotes {
        beachVotesCount += 1
    } else {
        chocolateFactoryVotesCount += 1
    }
}

beachVotesCount
chocolateFactoryVotesCount
 ...
 */
var salamanderCount: Int = 0
var marmotCount:Int =  0
var neitherCount:Int = 0

for mascotVote in mascotVotes {
    let salamanderVote = SchoolMascotOption.salamander
    let marmotVote = SchoolMascotOption.marmot
    if mascotVote == salamanderVote {
        salamanderCount += 1
    } else if mascotVote == marmotVote {
        marmotCount += 1
    } else {
        neitherCount += 1
    }
