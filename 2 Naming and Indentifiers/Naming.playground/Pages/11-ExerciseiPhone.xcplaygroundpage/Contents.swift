...
*/
let aGigabyteInMB = 1000
let maxOfiPhoneStorageCapaciyInMB = 8 * aGigabyteInMB
let currentCapacityOfiPhoneInMB = 3 * aGigabyteInMB
let aMinuteOfVideoStorage = 150
let availableStorageOfiPhoneInMB = maxOfiPhoneStorageCapaciyInMB - currentCapacityOfiPhoneInMB
let minutesOfVideoToFilliPhone = availableStorageOfiPhoneInMB / aMinuteOfVideoStorage
