...
var yesForShouldMascotChangeVote:Int = 0
var noForShouldMascotChangeVote:Int = 0

var yesShouldHaveMorePollOptionsVotes:Int = 0
var noShouldHaveMorePollOptionsVotes:Int = 0

var yesShouldInstallCoffeeVendingMachineVote: Int = 0
var noShouldInstallCoffeeVendingMachineVote: Int = 0
...
for shouldMascotChangeVote in shouldMascotChangeVotes {
    if shouldMascotChangeVote == true {
        yesForShouldMascotChangeVote += 1
        yes += 1
    } else {
        noForShouldMascotChangeVote += 1
        no += 1
    }
}
...
if yesForShouldMascotChangeVote > noForShouldMascotChangeVote {
    print("The vote for Should Mascot Change passed.")
} else {
    print("The vote for Should Mascot Change failed.")
}
...
for shouldMascotChangeVote in shouldMascotChangeVotes {
    if shouldMascotChangeVote == true {
        _ = shouldMascotChangeVotes.count
    } else {
        _ = shouldMascotChangeVotes.count
    }
}
...
for shouldInstallCoffeeVendingMachineVote in shouldInstallCoffeeVendingMachineVotes{
    if shouldInstallCoffeeVendingMachineVote  {
        yesShouldInstallCoffeeVendingMachineVote += 1
        yes += 1
    } else {
        noShouldInstallCoffeeVendingMachineVote += 1
        no += 1
    }
}

for shouldHaveMorePollOptionsVote in shouldHaveMorePollOptionsVotes {
    if shouldHaveMorePollOptionsVote {
        yesShouldHaveMorePollOptionsVotes += 1
        yes += 1
    } else {
        noShouldHaveMorePollOptionsVotes += 1
        no += 1
    }
}
/*:
...
printResults(forIssue: "Should we change mascot?", withVotes: shouldMascotChangeVotes)
printResults(forIssue: "Should have more poll options?", withVotes: shouldHaveMorePollOptionsVotes)
printResults(forIssue: "Should install coffee vending machine?", withVotes: shouldInstallCoffeeVendingMachineVotes)
