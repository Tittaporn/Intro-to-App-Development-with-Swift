...
let question = "\(questionWord) +  ?"

//let mainQuestion = ""

let name = "Kim"
let endLetter = "Please, kindly answering me. Thank you so much."
//let summons = "\(connectorWord)!"
...
//print(summons)
//print(botheration)
let letterMessage = "Hi! I am Lee, I am writting this to raach to \(name). I hope you are doing well. I have a question for you. \(questionWord) did you leave me at the party?, \(endLetter) "
